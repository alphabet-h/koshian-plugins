...
if [ -z "$MARKETPLACE_ROOT" ]; then
  ...
  bash <PLUGIN_ROOT>/skills/skill-creator-design/scripts/update-marketplace.sh \
  ...
  bash <PLUGIN_ROOT>/skills/skill-creator-design/scripts/update-marketplace.sh --yes \
    --marketplace-root "$MARKETPLACE_ROOT" \
    --plugin-name "<plugin-name>" \
    --plugin-source "./plugins/<plugin-name>" \
    --plugin-description "<description>"
